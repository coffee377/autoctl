...
func TestApplyBatch(t *testing.T) {
	...
	for i, id := range ids {
		...
		var dHook data.DictHook = func(key string) (*data.KV, bool) {
			for i, kv := range kvs {
...
func TestApply(t *testing.T) {
	...
	// Z0CLpnUoT3m-mtMZC8SQ2w07201742289469
	// WuaVoI30TnmDXnEKdYLdNQ07201741157155
	// p3vzP\_OWToqL3wjRN-cmOg07201748596924
	// Z-1hkhtFSse1z3OP2aNR5Q07201747903159
	// Hzyy3kVeTHSFSyHh8\_v6DQ07201747388905
	// OOiytnjQRq2y27dNERYhUA07201747368997
	// QK6b0JlyRMGrnPncPitn7A07201758585755
	// mgnNGND4QLO6YGpxOF8y-g07201757227481
	// cZaR7eizSE2hgjjGRt0zIA07201760422750
