...
type Account struct {
	...
	Username  string    `json:"username,omitempty" gorm:"type:string;size:32;unique;index:idx_account,priority:1"`  // 用户名
	Password  string    `json:"password,omitempty" gorm:"type:string;size:128"`                                     // 密码
