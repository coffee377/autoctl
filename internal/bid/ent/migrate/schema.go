...
var (
	...
	BidCaCertificateColumns = []*schema.Column{
		...
		{Name: "code", Type: field.TypeString, Size: 24, Comment: "CA证书编码"},
		{Name: "name", Type: field.TypeString, Size: 32, Comment: "CA证书名称"},
		{Name: "expiry_time", Type: field.TypeTime, Comment: "过期时间", SchemaType: map[string]string{"mysql": "datetime"}},
		...
		{Name: "last_renewal_at", Type: field.TypeTime, Nullable: true, Comment: "最后续费时间", SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "created_at", Type: field.TypeTime, Comment: "创建时间", SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "created_by", Type: field.TypeString, Nullable: true, Size: 32, Comment: "创建人"},
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时间", SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "updated_by", Type: field.TypeString, Nullable: true, Size: 32, Comment: "更新人"},
	...
	BidMemberAccountColumns = []*schema.Column{
		...
		{Name: "username", Type: field.TypeString, Size: 32, Comment: "账号"},
		{Name: "password", Type: field.TypeString, Nullable: true, Size: 32, Comment: "密码"},
		{Name: "register_person", Type: field.TypeString, Nullable: true, Size: 16, Comment: "注册人员"},
		{Name: "register_mobile", Type: field.TypeString, Nullable: true, Size: 16, Comment: " 注册手机号"},
